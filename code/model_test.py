...
parser.add_argument('--root_path', type=str,
                    default='/home/qiaoqiang/code/RAS4DG/dataset/feta2021', help='Name of Experiment')
parser.add_argument('--save_mode_path', type=str,
                    default='/home/qiaoqiang/code/RAS4DG/exp/RAS4DG/log_2024-01-09/01:07:31/last_model.pth', help='Save path of model')
parser.add_argument('--exp', type=str,
                    default='RAS4DG', help='Name of Experiment')
...
def t1st():
    ...
    for i_batch, sampled_batch in enumerate(valloader):
        ...
        pathological = sampled_batch['pathological']
    ...
    metric_list1 = metric_list1 / no_sick
    metric_list2 = metric_list2 / sick
    performance = np.array(metric_list).mean()
    performance1 = np.array(metric_list1).mean()
    performance2 = np.array(metric_list2).mean()
